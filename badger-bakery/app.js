...
function calculateSubtotal() {
	...
	let sum = bagelQuantity * 1.5 + donutQuantity * 1 + muffinQuantity * 2 + pieQuantity * 4.5 + cakeQuantity * 7;
...
function calculateSalesTax() {
	...
	const taxRatio = SALES_TAX[state];
	return roundMoney(taxRatio * sum);
}
...
document.getElementById("btnCheckout").addEventListener("click", () => {
	alert("Your tota is: $" + (calculateSubtotal() + calculateSalesTax()))
})
